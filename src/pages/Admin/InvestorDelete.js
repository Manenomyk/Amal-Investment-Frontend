...
function investDelete() {
  return (
    <div style={{fontFamily: "arial",}}>
      ...
      <p style={{marginLeft:"30%", marginBottom:"20px"}}><b><u><i>Investor delete</i></u></b></p>
     ...
     <div>
            <button style={{padding:"4px", marginLeft:"50%", background:'#007CBA', marginTop:"8%", color:"white", border:"0px", borderRadius:"7px"}}>Delete</button>
          </div>
    </div>
  );
}
export default investDelete;
