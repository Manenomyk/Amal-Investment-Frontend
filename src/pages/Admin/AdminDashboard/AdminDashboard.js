  ...
  return (
    ...
    <dash.Row className='mt-4'>
      <dash.Col className='mx-auto' lg={3}>
          <dash.Card id='homcard1' style={{boxShadow: "0px 3px 5px rgba(0, 0, 0, 0.5)",backgroundColor:"rgb(60, 110, 94)", color:"white"}}>
            <div className='text-center mt-2'>
                <p><i>Total projects</i></p>
              </div>


          <div className=''>
            <p style={{fontSize:"12px", marginLeft:'4px'}}>All projects:</p>
            <h3>23</h3>
      ...
      <dash.Col className='mx-auto' lg={3}>
          <dash.Card id='homcard1' style={{boxShadow: "0px 3px 5px rgba(0, 0, 0, 0.5)",backgroundColor:"rgb(74, 131, 9)", color:"white"}}>
            <div className='text-center mt-2'>
                <p><i>Total Shares</i></p>
              </div>
      ...
      <dash.Col className='mx-auto' lg={3}>
          <dash.Card id='homcard1' style={{boxShadow: "0px 3px 5px rgba(0, 0, 0, 0.5)",backgroundColor:"rgb(87, 122, 64)", color:"white"}}>
            <div className='text-center mt-2'>
                <p><i>Total capital</i></p>
              </div>


          <div className=''>
            <p style={{fontSize:"12px", marginLeft:'4px'}}>Capital invested:</p>
            <h3>23</h3>
            {/* <input style={{width:"3rem", fontSize:"12px",borderTop:"none", borderLeft:"none",borderRight:"none"}} placeholder="54" type="text" className='form-control shadow-none' /> */}
          </div>
      ...
      <dash.Col className='mx-auto' lg={3}>
          <dash.Card id='homcard1' style={{boxShadow: "0px 3px 5px rgba(0, 0, 0, 0.5)",backgroundColor:"rgb(114, 97, 62)", color:"white"}}>
            <div className='text-center mt-2'>
          ...
          <div className=''>
            <p style={{fontSize:"12px", marginLeft:'4px'}}>Projects invested in:</p>
            <h3>23</h3>
            {/* <input style={{width:"3rem", fontSize:"12px",borderTop:"none", borderLeft:"none",borderRight:"none"}} placeholder="54" type="text" className='form-control shadow-none' /> */}
          </div>
