...
export default function Tooltip() {
  ...
  return (
    ...
    marginBottom:"160%",
    width:"120px",
    height: "40px"}} offset={offset} >BUY</button>} position="top center">
        <div>You have successfully bought shares in Bora Estate</div>
    </Popup> */}

       {/* <button id="btn" onClick={openForm()}>BUY</button>
       <div className="popup" id="myForm">
           <button type="button" style={{textAlign:" right"}}
           className="btn-close" 
           aria-label="Close" id="myForm" 
           onClick={closeForm()} ></button>
           <p>You have successfully bought shares in Bora Estate</p>
       </div> */}
   </div> 
</div>  
  );
